...
{
    public class FCUTimerServices : IFCUTimerSevices
    {
        #region Properties
        ...
        public FCUTimerServices(IEventAggregator eventAggregator)
        {
            AddEventHandlers();
        ...
        private void OnStopped(object sender, TimerModelEventArgs e)
        {
            ...
            eventAggregator.GetEvent<FCU_ItemMessageEvent>().Publish(new FCUItemMessage { State = e.State.ToString() });
        }
    ...
    public interface IFCUTimerSevices
    {
