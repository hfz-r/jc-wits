...
{
    public class AHUTimerServices : IAHUTimerSevices
    {
        #region Properties
        ...
        public AHUTimerServices(IEventAggregator eventAggregator)
        {
            AddEventHandlers();
        ...
        private void OnTick(object sender, TimerModelEventArgs e)
        {
            ...
            eventAggregator.GetEvent<AHU_ItemMessageEvent>().Publish(new AHUItemMessage
            {
        ...
        private void OnStopped(object sender, TimerModelEventArgs e)
        {
            ...
            eventAggregator.GetEvent<AHU_ItemMessageEvent>().Publish(new AHUItemMessage { State = e.State.ToString() });
        }
    ...
    public interface IAHUTimerSevices
    {
