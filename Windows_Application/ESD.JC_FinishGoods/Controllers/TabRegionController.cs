    ...
    public class TabRegionController
    {
        ...
        private void InitTabRegion(long id)
        {
            ...
            navView.CloseViewRequested += delegate
            {
                ...
                _applicationCommands.DeleteCommand.UnregisterCommand(ahuViewModel.DeleteCommand);
                ...
                _applicationCommands.DeleteCommand.UnregisterCommand(fcuViewModel.DeleteCommand);
            ...
            _applicationCommands.DeleteCommand.RegisterCommand(ahuViewModel.DeleteCommand);
            ...
            _applicationCommands.DeleteCommand.RegisterCommand(fcuViewModel.DeleteCommand);
