...
{
    public class GITimerServices : IGITimerSevices
    {
        #region Properties
        ...
        public GITimerServices(IEventAggregator eventAggregator)
        {
            AddEventHandlers();
        ...
        private void OnStopped(object sender, TimerModelEventArgs e)
        {
            ...
            eventAggregator.GetEvent<GI_ItemMessageEvent>().Publish(new GIItemMessage { State = e.State.ToString() });
        }
    ...
    public interface IGITimerSevices
    {
